...
def expr_as_vector(expr: sy.Expr, dim: Optional[int] = None, 
                   symbol: sy.Symbol = g_sym) -> sy.Matrix:
    """
...
def vector_as_expr(v: sy.Matrix, expand: bool = True, 
                   symbol: sy.Symbol = g_sym) -> sy.Expr:
    """
